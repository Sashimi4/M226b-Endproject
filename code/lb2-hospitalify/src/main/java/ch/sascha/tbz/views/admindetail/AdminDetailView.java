package ch.sascha.tbz.views.admindetail;

import ch.sascha.tbz.data.entity.SamplePerson;
import ch.sascha.tbz.data.service.SamplePersonService;
import ch.sascha.tbz.views.MainLayout;
...
public class AdminDetailView extends Div implements BeforeEnterObserver {
    ...
    public AdminDetailView(@Autowired SamplePersonService samplePersonService) {
