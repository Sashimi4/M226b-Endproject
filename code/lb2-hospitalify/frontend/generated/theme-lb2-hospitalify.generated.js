...
import stylesCss from 'themes/lb2-hospitalify/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_lb2-hospitalify_componentCss']) {
    
    document['_vaadintheme_lb2-hospitalify_componentCss'] = true;
  }
